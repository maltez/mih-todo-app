...
angular.module('users').directive('passwordValidator', ['PasswordValidator', "$popover", function (PasswordValidator, $popover) {
	return {
		require: 'ngModel',
...
//# sourceMappingURL=password-validator.client.directive.js.map